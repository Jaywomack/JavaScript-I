...
//{"id":33,"car_make":"Jeep","car_model":"Wrangler","car_year":2011},
    ...
    //         console.log( `Car 33 is a ${inventory[i].car_model}`)
    //     }
    // }
    // }
...
// console.log(`Car 33 is a ${Object.values(inventory)[32].car_year} *car make goes here* *car model goes here*` );//Way over complicated way of doing it lol
...
let lastCar = 0;
console.log(`The make and model of the last vehicle is: ${inventory[inventory.length -1].car_make}${inventory[inventory.length -1].car_model} `);
